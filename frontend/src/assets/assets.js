...
export const AiToolsData = [
  {
    title: 'Type → Boom. Blog.',
    description: 'Write articles with zero effort. You type, AI delivers.',
    Icon: SquarePen,
  ...
  {
    title: 'AI Picasso',
    description: 'Turn text into banger visuals. Say it → See it.',
    Icon: Image,
  ...
  },
  {
    ...
    description: 'Let AI roast (and fix) your resume so you actually get replies.',
    Icon: FileText,
